...
namespace Simple_randomizer_SoC.Language {
    ...
    internal class ru_local {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Программа теоретически может быть использована со многими модами (Если мод не нарушает логику оригинальных игровых файлов).
        ///
        ...
        ///
        ///Если в модификации есть дополнительные модели и озвучка НПС, нужно просто прописать пути к ним сп [остаток строки не уместился]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Вероятность дождя для каждого класса погоды (0 - остается как в оригинале).
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Вероятность грозы для каждого класса погоды (0 - остается как в оригинале).
        /// </summary>
